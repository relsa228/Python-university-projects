...
def index(request):
    ...
    for el in bitcoin_quore:
        ...
        list_of_btc_date.append(str(el.date)[5:-10])
...
def eth_overview(request):
    ...
    for el in ether_quore:
        ...
        list_of_eth_date.append(str(el.date)[5:-10])
...
def ltc_overview(request):
    ...
    for el in litecoin_quore:
        ...
        list_of_ltc_date.append(str(el.date)[5:-10])
...
def xrp_overview(request):
    ...
    for el in ripple_quore:
        ...
        list_of_xrp_date.append(str(el.date)[5:-10])
...
def dash_overview(request):
    ...
    for el in dash_quore:
        ...
        list_of_dash_date.append(str(el.date)[5:-10])
...
def zec_overview(request):
    ...
    for el in zcash_quore:
        ...
        list_of_zec_date.append(str(el.date)[5:-10])
